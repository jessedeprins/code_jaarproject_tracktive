...
// SQL query: berekent totale sporttijd per maand (in minuten)
$query = "
...
while ($row = $result->fetch_assoc()) {
    ...
    // Sla totale tijd op (float, minuten kunnen decimalen hebben)
...
<html>
<head>
<title>Sporttijd per maand</title>
...
<h2>Sporttijd per maand (minuten)</h2>

<!-- Canvas waar grafiek wordt getekend -->
<canvas id="tijdChart" width="800" height="400"></canvas>

<script>
// Labels (maanden) vanuit PHP
const labels = <?php echo json_encode($labels); ?>;

// Data (tijd in minuten) vanuit PHP
